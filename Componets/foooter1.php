...
<body>
  ...
  <div class="container-fluid mt-4 mb-4">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <!-- Blog Post -->
        <div class="blog-post">
          <h2 class="blog-post-title">Lets rebuild Agriculture together</h2>
          <p class="blog-post-meta">January 1, 2024 by <a href="#">Group3</a></p>
          <p>Making agriculture more profitable by accessing information at our fingertips</p>
 ...
 it should be like this page please: <!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
