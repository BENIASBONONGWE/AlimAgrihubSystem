...
<body>
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <input type="text" id="phone" name="phone" value="+265" readonly onmousedown="this.removeAttribute('readonly');" onkeydown="this.removeAttribute('readonly');">
            <br>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $phoneNumber = $_POST['phone']; // This will be pre-filled with the country code
